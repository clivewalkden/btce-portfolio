...
function exchanges() {
	return array(
		"btc_usd" => array("btc" => 0 ,"usd" => 0 ),
		"btc_rur" => array("btc" => 0 ,"rur" => 0 ),
		"btc_eur" => array("btc" => 0 ,"eur" => 0 ),
		"ltc_btc" => array("ltc" => 0 ,"btc" => 0) ,
		"ltc_usd" => array("ltc" => 0 ,"usd" => 0 ),
		"ltc_rur" => array("ltc" => 0 ,"rur" => 0) ,
		"nmc_btc" => array("nmc" => 0 ,"btc" => 0 ),
		"usd_rur" => array("usd" => 0 ,"rur" => 0 ),
		"eur_usd" => array("eur" => 0 ,"usd" => 0 ),
		"nvc_btc" => array("nvc" => 0 ,"btc" => 0 ),
		"trc_btc" => array("trc" => 0 ,"btc" => 0 ),
		"ppc_btc" => array("ppc" => 0 ,"btc" => 0),
		"ftc_btc" => array("ftc" => 0 ,"btc" => 0),
		"cnc_btc" => array("cnc" => 0 ,"btc" => 0)
	);
}
